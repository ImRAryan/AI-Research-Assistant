        ...
        <div className="min-h-screen bg-gray-100 dark:bg-gray-900 transition-colors">
            ...
            <div className="px-10 py-10">
                ...
                <div className="flex items-center justify-between mb-10">
                    <h1 className="text-4xl font-bold text-gray-900 dark:text-white">My Project</h1>
                    <button
                ...
                {loading ? (
                    ...
                    <p className="text-gray-500 dark:text-gray-400">No projects yet. Create one!</p>
                ) : (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {projects.map((w) => (
                            ...
                            >
                                <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">{w.project_name}</h2>
